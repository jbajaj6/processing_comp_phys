...
# create array of celesitals with all 
...
def move():
    ...
    #     F = Vec(0, 0, 0)
    #     for pull in celestials:
    #         if pull != celestial:
    #             force = fg(pull, celestial)
    #             F.plus(force)
    #     a = Vdiv(F, celestial.m)
    #     celestial.updateVel(a, dt)
    #     celestial.move(dt)
        

    """ WITH ONLY CALCULATING ONCE """
    d = {}
